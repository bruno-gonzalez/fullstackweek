    ...
    return ( 
        <div>
             <div className="h-[250px] w-full relative">
                ...
                <Button size="icon" onClick={handleBackClick} variant={'outline'} className="absolute bg-gray-900 z-50 top-3 left-3">
                    <ChevronLeftIcon />
                </Button>

                <Button size="icon" variant={'outline'} className="absolute bg-gray-900 z-50 top-3 right-3">
                    <MenuIcon />
                </Button>
